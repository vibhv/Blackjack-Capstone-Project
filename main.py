...
def play_game():
	...
	# 6: Deal the user and computer 2 cards each using deal_card()
	user_cards = []
	computer_cards = []
	is_game_over = False
	...
	# 7: The score will need to be rechecked with every new card drawn and the checks in 8 need to be repeated until the game ends.
